...
思路：2的N次方的分布如下(只考虑N>=0的情况)，1，2，4，8，16，32，，，，，，
	  1.递归法。观察上述数列，排除第1项，从4开始，后面的每一项除以2以后都依然是2的幂，则可以运用递归法，
	  每次将整数折半，递归求解

	  2.位与法。如果一个t数是2的幂，假设t=2^n,则t-1=2^n-1。如果将该整数表示为2进制，则t的第n位数字为1，其他位为0，t-1的第n位为0，第n-1到第1位都为1，则二者按位与则为0，根据这一性质即可判断该整数是否是2的幂。
	   t     10000000......0
       	   t-1   01111111......1
	   结果  00000000......0
 * */
